...
global.owner = process.env.OWNER_NUMBER  || '263785192259' ;  // ADD YOUR NUMBER WITHOUT +
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/3nCaCQN.jpeg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝚃𝙰𝙺𝚇-𝙾𝙵𝙲',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝚃𝙰𝙺𝚇-𝙾𝙵𝙲" ,          // ADD YOUR STICKER PACKNAME
